...
buildDotnetModule (finalAttrs: {
  pname = "nexusmods-app" + lib.optionalString _7zz.meta.unfree "-unfree";
  version = "0.21.1";
  ...
  meta = {
    ...
    description = "Discontinued game mod installer, creator and manager";
    longDescription = ''
      A discontinued mod installer, creator and manager for:
      - Baldur's Gate 3
      - Cyberpunk 2077
      - Mount & Blade II: Bannerlord
      - Stardew Valley

      [Discontinued] by Nexus Mods, who are focusing on improving [Vortex] instead.
